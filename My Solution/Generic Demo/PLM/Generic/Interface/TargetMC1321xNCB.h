...
************************************************************************************/
  ...
  #define gLCDModule_c       gPC1602Fx_c
  
  #define gLcdTurnOnPin_c    0x01
  #define gLcdRegSelectPin_c 0x02
  #define gLcdEnablePin_c    0x04
  #define gLcdReadWritePin_c 0x08  
  #define gLcdCtrlPort_c     0x01
  #define gLcdDataPort_c     0x01  
