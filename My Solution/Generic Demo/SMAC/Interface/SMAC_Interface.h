...
/*If gCcaBeforeTx_d is set to TRUE SMAC will perform gCcaAttemps_d
  CCAs before transmitting packets, SMAC will sent the paket at the 
  fist succesfuly CCA*/
#define gCcaBeforeTx_d     FALSE
#define gCcaAttemps_d      1
...
#if gTargetXcvr_c == gXcvrMc1321x_c || gTargetXcvr_c == gXcvrMc1320x_c || gTargetXcvr_c == gXcvrMc1319x_c
...
*
* Return value: 
*   uint8_t: 8 bit value representing the link quality value in dBms.
*
************************************************************************************/
...
*
************************************************************************************/
extern uint8_t MLMEEnergyDetect(void); 
